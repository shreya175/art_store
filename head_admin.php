...
<body>
 ...
 <div class="dpdown">
 <a href="home.php"><img src="pictures/logo.png" class="img-responsive" style="width: 50px;"></a>
  ...
  <div class="dpdown-content" style="left:0;">
                   <a href="artworks.php">Artworks</a>
                    <a href="artist.php">Artists</a>
                     ...
                     ------------------------------------<br>
                    <a href="about_us.php"> About ART STORE</a>
  </div>
</div>


  <h1 class="ART">ART </h1>
  <h1 class="_BAY">STORE </h1>

  <h2 class="Albay_">Always </h2>
                 ...
                 '<div class="dropdown3">'.
                    '<button onclick="myFunction()" class="dropbtn3">' .$row['user_fname'].' '.$row['user_mname'].' '.$row['user_lname']. ''.''. '&#9660;'. '</button>'.'
                       <div id="myDropdown" class="dropdown-content3">
                        <a href="account_home.php">My ART STORE Admin</a>
