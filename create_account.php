...
$nameErr = $emailErr = $mobilenoErr = $genderErr = $websiteErr = $mobilenoErr = "";  
...
//String Validation  
    ...
    if (isset($_POST['email'])) {  
            ...
            $USER_EMAIL = input_data($_POST['email']);  
    ...
    if (isset ($_POST["gender"])) {  
            ...
            $USER_GENDER = input_data($_POST['gender']);  
    }   
...
echo "<script type=\"text/javascript\">window.alert('Password not match !');window.location.href = 'create_account.php';</script>";
}
...
$sql="INSERT INTO user (username,password,cpassword,USER_FNAME,USER_MNAME,USER_LNAME,USER_GENDER,USER_AGE,USER_BDAY,
USER_CONTACT,USER_MUNICIPAL,USER_PROVINCE,USER_ZIPCODE,USER_BRGY,USER_STREET,USER_HOUSE_NUMBER,USER_IMAGEPATH,
USER_TYPE,USER_EMAIL) VALUES 
('$username','$password','$cpassword','$USER_FNAME', '$USER_MNAME','$USER_LNAME','$USER_GENDER',
...
<div class="border">
      ...
      <form action = "create_account.php" enctype="multipart/form-data" method="POST">
			...
			<hr class="hr" style="border-bottom: 2px solid #2d70d5;"></h2>
           ...
           <p class="fsize-text"> 
		   Username: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		   <input class="textbox" type="text" required name="username" >
			    <span class="error">* <?php echo $nameErr; ?> </span>    
		   <br><br>

           Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		   <input class="textbox" type="password" required name="password" >
		   <br><br>
		   ConfirmPassword:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		   <input class="textbox" type="password" required name="cpassword" >
		   <br><br>
            </p>
            ...
            <p class="fsize-text">
			First name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input class="textbox" type="text" id="Fname" required name="Fname">
			    <span class="error">* <?php echo $nameErr; ?> </span>  
			<br><br>
            
			Middle name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input class="textbox" type="text" id="Mname" name="Mname" >
			    <span class="error">* <?php echo $nameErr; ?> </span>  

			<br><br>
            
			Last name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input class="textbox" type="text" id="Lname" required name="Lname" >
			    <span class="error">* <?php echo $nameErr; ?> </span>  
            <br><br>
		  ...
		  <select class="Gender" name="gender">
		   ...
		   Age:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input class="textbox" type="text" id="age" required name="age">
			<br><br>

            Birthdate:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input class="textbox" type="text" id="bday" name="bday">
			...
			Email address:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input class="textbox" type="text" id="email" required name="email">
			    <span class="error">* <?php echo $emailErr; ?> </span>  
			<br><br>

            House Number:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input class="textbox" type="text" id="House_num" name="House_num">  
			<br><br>

            Street:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input class="textbox" type="text" id="Street" name="Street">  
			<br><br>
            
			District:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="Brgy" name="Brgy" ><br><br>

            City      :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input class="textbox" type="text" id="municipal" name="municipal" > 
			<br><br>
            
			State:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input class="textbox" type="text" id="province" name="province">  
			<br><br>
