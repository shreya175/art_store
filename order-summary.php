        ...
        <form  class="border" action = "shipping_process(planb).php" method="POST" > <br><br><br><br><br><br><br><br><br><br>
         ...
         <p class="delivery">
          <?php
           ...
           <p class="price">Rupees <?php echo $price;?>.00 <br><br><br><br><br></p><br>

           <p class="special">Subtotal Fee<?php echo $total_price;?>.00<br>
           ...
           <p class="total">Total(Tax included) Rupees <?php echo $total_price;?>.00</p>
